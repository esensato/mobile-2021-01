...
class MainActivity : AppCompatActivity() {
    ...
    var repeticoes = 1
    // posição do item sorteado no array
    var pos = 0
    ...
    fun iniciar(view:View) {
        ...
        // efetuar o sorteio da sequencia dos botoes
        sorteados = sortear()
        pos = 0
        timer = Timer()
        var apagar = true
        ...
        timer.schedule(object: TimerTask() {
               override fun run() {
                   if (pos == sorteados.size) {
                       ...
                       // obtem a referencia ao botao que ira "piscar"
    ...
    // sorteia uma quantidade de numeros (0..3) baseado na quantidade de repeticoes atual
